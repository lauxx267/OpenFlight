 ...
 * \ingroup control_fcns
 */
		struct sensordata *sensorData_ptr;	///pointer placed to fix an unexplainable warning
		struct nav *navData_ptr;			///pointer placed to fix an unexplainable warning
		struct control *controlData_ptr;	///pointer placed to fix an unexplainable warning
		struct mission *missionData_ptr;	///pointer placed to fix an unexplainable warning


///extern void part for init_control below added to declare function in main
extern void init_control(double time, 			///< [sec], time since in autopilot mode
